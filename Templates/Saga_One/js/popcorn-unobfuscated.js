                                ...
                                C = function(j) {
                                    ...
                                    if (clickedFeature.attributes.text) {
                                        m = new OpenLayers.Popup.FramedCloud("featurePopup", clickedFeature.geometry.getBounds().getCenterLonLat(),
                                            new OpenLayers.Size(120, 250), clickedFeature.attributes.text, null, true,
                                            function() {
...
//            console.log(1);
            l._container.style.display = "inline"
            // $(l).find("span").style.display = "none"
            // l._mainspan.style.display = "none"
            $(l._mainspan).hide();
        },
        end: function(e, l) {
            l._container.style.display = "none"
            // l._mainspan.style.display = "inline"
            $(l._mainspan).show();
        },
        _teardown: function(e) {
            var l = p.dom.find(e.target);
    ...
    p.plugin("image", {
        ...
        _setup: function(b) {
            ...
            h.addEventListener("load", function() {
                ...
                // b.anchor.onclick = "alert(1);return false;"
